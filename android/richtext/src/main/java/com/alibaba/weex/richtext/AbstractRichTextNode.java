...
/*  public static Spanned parseJSON(String json){
  ...
  public Spanned toSpan() {
    ...
    if (children != null) {
      for (AbstractRichTextNode child : children) {
  ...
  private void parseHrefNode(){

  }

  private void parseImageNode(){
  ...
  public String toString() {
    if (attr != null) {
      if (type != null && TextUtils.equals(type, IMAGE_NODE)) {
        return type;
      } else {
